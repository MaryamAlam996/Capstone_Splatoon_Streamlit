...
# function to show all stats on the weapon class page
def Show_Class_Stats(selected_class, colour1, colour2):
    Show_Ability_Stats(selected_class, colour1, colour2)
...
def Show_Ability_Stats(selected_class, colour1, colour2):
    ...
    st.divider()
    # Message showing how many builds this weapon class has
    ...
    fig = px.bar(track_abilities_df,
                 ...
                 title=f"Average ability points for {selected_class} builds",
    ...
    fig2 = px.bar(
        ...
        title=(
            f"Usage of primary only abilities for {selected_class} builds"
        ),
